    ...
    stepDisplay.open(map, marker);
          ...
          //---------------------------------------------
			...
			$scope.data = {}
				  ...
				  var myPopup = $ionicPopup.show({
//					 template: '<input type = "text" ng-model = "data.model">',
					 title: 'You have finished your work today!',
					 scope: $scope,
